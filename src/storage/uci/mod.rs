...
use self::tree::uci_config::UciConfig;
use self::tree::uci_option::{UciOption, UciOptionType};
use self::tree::uci_section::UciSection;
...
impl UciTree {
    ...
    fn _load_config(&self, name: &str) -> Result<()> {
